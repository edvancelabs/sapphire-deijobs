            ...
            <div class="card-center">
                <div class="ps-5 pe-5">
                    ...
                    <div class="input-style no-borders has-icon validate-field">
                        ...
                        <input type="name" class="form-control validate-name fname" name="name" id="form1a" placeholder="First Name">
                        <label for="form1a" class="color-blue-dark font-10 mt-1">First Name</label>
                    ...
                    <div class="input-style no-borders has-icon validate-field">
                        <i class="fa fa-user"></i>
                        <input type="name" class="form-control validate-name lname" name="last_name" id="form1a" placeholder="Last Name">
                        <label for="form1a" class="color-blue-dark font-10 mt-1">Last Name</label>
                        <i class="fa fa-times disabled invalid color-red-dark"></i>
                        <i class="fa fa-check disabled valid color-green-dark"></i>
                        <em>(required)</em>
                    </div>
                    <div class="input-style no-borders has-icon validate-field mt-2">
                        <i class="fa fa-at"></i>
                        <input type="email" class="form-control validate-name email" name="email" id="form1aa" placeholder="Email">
                    ...
                    <div class="input-style no-borders has-icon validate-field mt-2">
                        <i class="fa fa-at"></i>
                        <input type="text" class="form-control validate-name age" name="age" id="form1aa" placeholder="Age">
                        <label for="form1aa" class="color-blue-dark font-10 mt-1">Age</label>
                        <i class="fa fa-times disabled invalid color-red-dark"></i>
                        <i class="fa fa-check disabled valid color-green-dark"></i>
                        <em>(required)</em>
                    </div>
                    <div class="input-style no-borders has-icon validate-field mt-2">
                        <i class="fa fa-at"></i>
                        <select style="background-color: white" name="sex" id="sex">
                        <option type="dropdown" value="male" id="form1aa">Male</option>
                        <option type="dropdown" value="female" id="form1aa" placeholder="Sex">Female</option>
                        </select>
                        <label for="form1aa" class="color-blue-dark font-10 mt-1">Sex</label>
                        <i class="fa fa-times disabled invalid color-red-dark"></i>
                        <i class="fa fa-check disabled valid color-green-dark"></i>
                        <em>(required)</em>
                    </div>
                    <div class="input-style no-borders has-icon validate-field mt-2">
                        ...
                        <input type="password" class="form-control validate-text password" id="form3a" placeholder="Choose a Password">
                    ...
                    <div class="input-style no-borders has-icon validate-field mt-2">
                        <i class="fa fa-lock"></i>
                        <input type="password" class="form-control validate-text confirm_pass" id="form3a1" placeholder="Confirm your Password">
                    ...
                    <div class="text-center mb-5 mt-5">
                        <a href="/buddy/" class="font-12">Already Registered? Sign in Here</a>
                    </div>

                    <a href="#" id="create_account" class="back-button btn btn-full btn-m shadow-large rounded-sm text-uppercase font-900 bg-highlight">Create Account</a>
                </div>
            </div>
        </div>
