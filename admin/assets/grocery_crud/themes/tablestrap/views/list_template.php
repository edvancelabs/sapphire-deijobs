...
<div class="grocerycrud-container panel panel-default">
	...
	<div class="dataTablesContainer">
		<div class="panel-body">
			<?php if(!$unset_add){?>
				<a role="button" class="add_button btn bg-cityb hidden-xs" href="<?php echo $add_url?>">
			...
			<div class="pull-right">
				<?php if(!$unset_export && $rfu_data['export'] != "hide"){?>
					<a role="button" class="add_button btn bg-cityb" href="<?php echo $export_url?>">
						<span class="glyphicon glyphicon-save-file"></span>
						<?php echo $this->l('list_export');?>
					</a>
				<?php }?>
				<?php if(!$unset_export && $rfu_data['export'] != "hide"){?>
					<a role="button" class="add_button btn bg-cityb" href="<?php echo $print_url?>">
