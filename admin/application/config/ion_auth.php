...
/*
 ...
 |
 */
$config['hash_method']			= 'argon2id';	// bcrypt, argon2, or argon2id
 ...
 */
$config['site_title']                 = "Ezipay.in";       // Site Title, example.com
$config['admin_email']                = "admin@ezipay.in"; // Admin Email, admin@example.com
$config['default_group']              = 'merchant';           // Default group, use name
...
$config['email_config'] = Array(
    ...
    'smtp_port' => 465,
    'smtp_user' => 'connect@bookmysabzi.com',
    'smtp_pass' => 'Bms@54321',
    'mailtype'  => 'html', 
    'charset'   => 'iso-8859-1'
);
