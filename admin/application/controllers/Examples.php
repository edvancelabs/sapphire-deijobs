...
class Examples extends CI_Controller {
	...
	public function offices_management()
	{
		try{
			...
			$crud->set_relation('mentor_id','users', 'username');
			$crud->set_subject('subscription');
			// $crud->required_fields('city');
			$crud->columns('id','user_id','mentor_id','start_date','end_date','activate');
	...
	function encrypt_password_and_update($post_array, $primary_key) {
		if($post_array['activate'] == 1){
	    	$user_id = $post_array['user_id'];
	    	$mentor_id = $post_array['mentor_id'];
